#bugfix the error: undefined local variable or method `paths' for #<ActiveAdmin::FileUpdateChecker:0x3887400>
if ActiveAdmin::VERSION == "0.3.4" && Rails.version =~ /^3\.2\./
